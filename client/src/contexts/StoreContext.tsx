...
const productData: Product[] = [
  {
    ...
    image: "/src/assets_dir/images/praetorian-products-updated.png",
    category: "Coating",
    size: "1-gallon",
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    image: "/src/assets_dir/images/praetorian-bucket-1gallon.png",
    category: "Stucco",
    size: "1-gallon",
    inStock: true,
    rating: 4.8
  },
  {
    ...
    image: "/src/assets_dir/images/praetorian-bucket-5gallon.png",
    category: "Stucco",
    size: "5-gallon",
    inStock: true,
    baseProduct: 3,
