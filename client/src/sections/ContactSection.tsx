                ...
                <div className="mt-4">
                  ...
                  <div className="flex space-x-6 inline-flex">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="dark:bg-gradient-to-br dark:from-gray-800 dark:via-gray-700 dark:to-gray-900 bg-gradient-to-br from-gray-100 via-white to-gray-200 w-16 h-16 rounded-full flex items-center justify-center transition-all hover:scale-110 dark:shadow-[0_0_10px_rgba(29,161,242,0.2)] shadow-[0_0_5px_rgba(0,0,0,0.1)] border border-gray-200/30 dark:border-sky-500/30 group"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 dark:text-sky-400 text-sky-500 group-hover:text-sky-600 dark:group-hover:text-sky-300 transition-colors">
