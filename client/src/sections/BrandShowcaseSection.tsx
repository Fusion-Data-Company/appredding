          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <div className="relative group transform hover:scale-[1.02] transition-all duration-500 hover:-translate-y-1 hover:z-10">
                <div className="relative bg-black rounded-xl p-8 shadow-[0_10px_50px_rgba(0,0,0,0.5)] z-10 space-y-8 min-h-[896px]">
                  {/* Background gradient box completely removed */}
                  
                  {/* Border styling updated to match screenshot - clean orange border */}
                  <div className="absolute inset-0 rounded-xl border-2 border-orange-500/50 z-0 overflow-hidden" 
                       style={{ height: 'calc(100% + 48px)', top: '-24px', bottom: '-24px' }}>
                  </div>
                  ...
                  {/* Corner accents removed as per screenshot */}
