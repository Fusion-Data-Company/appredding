...
const HeroSection = () => {
  return (
    <section className="w-full bg-black overflow-visible pt-0 mt-0 relative" style={{ marginBottom: "0", zIndex: 20 }}>
      ...
      <div className="w-full flex justify-center items-center overflow-visible py-0 my-0" style={{ height: "800px" }}>
        {/* Removed vignette overlay */}
        
        {/* Removed black bar */}
        
        {/* The hero image with enhanced styling for ultra-realistic appearance */}
        <div className="relative w-full overflow-visible" style={{ height: "800px" }}>
          <div className="absolute inset-0" style={{ 
            ...
            <img 
              ...
              style={{ 
                ...
                width: "100%", 
                height: "800px", // Taller height as requested
