    ...
    >
      ...
      <div className="container mx-auto px-4 relative" style={{ zIndex: 2 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-stretch h-full">
          {/* Left column - NASA Technology Content - exact same dimensions as right column */}
          <div className="relative w-full md:w-1/2 p-8 group transform hover:scale-[1.01] transition-all duration-700 h-full flex flex-col">
            ...
            {/* Premium Card Container - exact match to right column dimensions */}
            <div className="relative flex-1 bg-gradient-to-br from-gray-900/95 via-gray-950/95 to-black backdrop-blur-xl rounded-xl py-6 px-8 z-10 border border-orange-500/30 overflow-hidden group hover:shadow-[0_0_25px_rgba(249,115,22,0.3)] transition-shadow duration-500 flex flex-col h-full">
          ...
          {/* Right column - Premium Timeline Card - matching left column exactly */}
          <div className="group relative w-full md:w-1/2 p-8 transform hover:scale-[1.01] transition-all duration-700 h-full flex flex-col">
            {/* Multiple layered background effects - Mixed theme with subtle glow */}
            <div className="absolute -inset-1 bg-gradient-to-r from-orange-600/40 via-blue-600/40 to-orange-600/40 rounded-xl blur-xl opacity-70 group-hover:opacity-100 group-hover:blur-xl transition-all duration-1000 animate-pulse-slow"></div>
            <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-500/80 via-blue-500/80 to-orange-500/80 rounded-xl blur-md opacity-90 group-hover:opacity-100 transition-all duration-500"></div>
            
            {/* Premium Card Container with enhanced styling - matching left column exactly */}
            <div className="relative flex-1 bg-gradient-to-br from-gray-900/95 via-gray-950/95 to-black backdrop-blur-xl rounded-xl py-6 px-8 z-10 border border-orange-500/30 overflow-hidden group hover:shadow-[0_0_25px_rgba(249,115,22,0.3)] transition-shadow duration-500 flex flex-col h-full">
