      ...
      <div className="container mx-auto px-4 relative" style={{ zIndex: 2 }}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-24">
            <div className="bg-gray-800/70 backdrop-blur-xl border-4 border-gray-600/40 rounded-lg p-10 transform transition-all hover:scale-105 hover:translate-y-[-10px] shadow-[0_0_40px_rgba(255,255,255,0.25)] h-full min-h-[280px] flex flex-col justify-between">
