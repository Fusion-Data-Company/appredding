      ...
      <div className="container mx-auto px-4 relative" style={{ zIndex: 2 }}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-24">
            <div className="bg-gradient-to-b from-gray-800/70 to-gray-900/80 backdrop-blur-xl rounded-xl border-0 shadow-[0_10px_50px_rgba(251,191,36,0.2)] dark:shadow-[0_10px_50px_rgba(0,0,0,0.4)] p-10 transform transition-all hover:scale-105 hover:-translate-y-2 h-full min-h-[280px] flex flex-col justify-between overflow-hidden relative before:absolute before:inset-0 before:p-[2px] before:rounded-xl before:bg-gradient-to-br before:from-amber-300 before:via-amber-200 before:to-amber-400 dark:before:from-amber-700 dark:before:via-amber-600 dark:before:to-amber-800 before:-z-10">
