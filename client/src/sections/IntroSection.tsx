    ...
    <section className="dark:bg-gradient-to-b dark:from-black dark:to-gray-900 bg-gradient-to-b from-[#f5f2e8] to-[#f8f5ee] py-16">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="dark:bg-gray-800/60 bg-gray-400/30 backdrop-blur-2xl rounded-xl border-4 dark:border-white border-gray-300/50 dark:shadow-[0_0_60px_rgba(255,255,255,0.4)] shadow-[0_0_30px_rgba(0,0,0,0.1)] py-8 px-6 md:px-10 mx-auto max-w-3xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="dark:bg-gray-800/70 bg-gray-400/20 backdrop-blur-xl border-4 dark:border-white border-gray-300/50 rounded-lg p-6 hover:translate-y-[-5px] transition-transform duration-300 dark:shadow-[0_0_60px_rgba(255,255,255,0.4)] shadow-[0_0_30px_rgba(0,0,0,0.1)]">
