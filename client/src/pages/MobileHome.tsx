...
import { 
  ...
  BarChartHorizontal as BarChart3,
  Info as InfoIcon,
  FileText,
  Download,
  TrendingUp,
        ...
        <section className="relative z-10 py-10 overflow-hidden">
          <div className="container mx-auto mb-12">
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden transform transition-all duration-700 group hover:scale-[1.005] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.6)] border border-blue-600/40">
                ...
                {/* Ultra-premium header background with enhanced pattern and dynamic overlay */}
                ...
                {/* Enhanced particle effect overlay with floating light points */}
                ...
                {/* Subtle digital circuit pattern overlay */}
                <div className="absolute inset-0 opacity-5 z-0"
                  style={{
                    backgroundImage: "url('data:image/svg+xml,%3Csvg width=\"40\" height=\"40\" viewBox=\"0 0 40 40\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fill-rule=\"evenodd\"%3E%3Cpath d=\"M0 20L20 0h10L0 30v-10zm10 0L30 0h10L10 30v-10z\" fill=\"%2359a5fc\" fill-opacity=\"0.3\"%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E')",
                    ...
                    <div className="space-y-6 mb-8">
                      ...
                      <div className="relative group p-6 bg-gradient-to-br from-black/80 to-gray-900/80 border border-red-500/30 rounded-xl transition-all duration-300 hover:border-red-500/50 shadow-[0_4px_15px_rgba(0,0,0,0.3)]">
                        ...
                        <div className="relative flex gap-5">
                          ...
                          <div>
                            <h3 className="font-bold text-xl text-transparent bg-clip-text bg-gradient-to-r from-red-300 to-red-200 mb-3" style={{ textShadow: "0 1px 2px rgba(0,0,0,0.8)" }}>Uncomfortable Living Conditions</h3>
                            <p className="text-gray-200 leading-relaxed">
                              Does your mobile home feel like an oven in summer and a freezer in winter? Indoor temperatures in standard mobile homes can fluctuate by <span className="text-red-300 font-medium">22°F in a single day</span>, making consistent comfort impossible. Many owners resort to space heaters or window units, creating safety hazards and further increasing energy waste.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative group p-6 bg-gradient-to-br from-black/80 to-gray-900/80 border border-red-500/30 rounded-xl transition-all duration-300 hover:border-red-500/50 shadow-[0_4px_15px_rgba(0,0,0,0.3)]">
                        ...
                        <div className="relative flex gap-5">
                          ...
                          <div>
                            <h3 className="font-bold text-xl text-transparent bg-clip-text bg-gradient-to-r from-red-300 to-red-200 mb-3" style={{ textShadow: "0 1px 2px rgba(0,0,0,0.8)" }}>Rapid Deterioration & Depreciation</h3>
                            <p className="text-gray-200 leading-relaxed">
                              Have you noticed your mobile home aging before your eyes? Without proper protection, mobile homes deteriorate <span className="text-red-300 font-medium">3.2x faster than traditional homes</span>, with roofs lasting only 10-15 years and exterior surfaces requiring repainting every 3-5 years just to maintain basic appearance and weatherproofing.
                            </p>
                          </div>
                        </div>
                      </div>
