          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto text-center mb-16 relative">
              ...
              <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-950/90 to-black/90 py-10 px-12 rounded-xl border border-gray-800 shadow-[0_10px_25px_rgba(0,0,0,0.3)]">
                ...
                <div className="mt-8 p-6 relative bg-gradient-to-br from-black/80 to-gray-900/80 border-2 border-green-600/50 rounded-xl transition-all duration-300 mb-8 shadow-[0_6px_20px_rgba(74,222,128,0.15)] z-10">
                  {/* Enhanced layered ambient green glows - all with negative z-index to ensure they stay behind */}
                  <div className="absolute -inset-2 bg-green-500/20 rounded-xl blur-2xl opacity-70 -z-10"></div>
                  <div className="absolute -inset-4 bg-green-500/15 rounded-xl blur-3xl opacity-60 -z-10 animate-pulse-slow"></div>
                  <div className="absolute -inset-px bg-gradient-to-r from-green-600/20 via-transparent to-green-600/20 rounded-xl opacity-80 blur-sm -z-10"></div>
                  ...
                  <div className="flex justify-center mb-4">
                    {/* Ambient purple registration button glow - behind the button */}
                    <div className="relative">
                      <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/50 to-purple-400/50 rounded-lg blur-md opacity-80 group-hover:opacity-100 transition duration-300 -z-10"></div>
                      <div className="absolute -inset-3 bg-purple-500/20 rounded-xl blur-xl opacity-70 animate-pulse-slow -z-10"></div>
                      <div className="relative">
                        <PremiumActionButton
