...
const CommercialSolar = () => {
  ...
  return (
    <MainLayout fullWidth={true}>
      ...
      {/* Enhanced Enterprise Solar Hero Section */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-semibold text-blue-400 uppercase tracking-wider">C-10 #1084287 • NABCEP PV-102419 • CPUC Fast Track Certified</span>
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">
              Enterprise Solar + Storage Systems
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 max-w-5xl mx-auto mb-4">
              Sol-Ark 30K/60K three-phase inverters with advanced demand charge management, delivering 40-60% peak reduction
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8 text-sm">
              <div className="flex items-center gap-2 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700">
                ...
                <span className="text-gray-400">PG&E B-19 Demand:</span>
                <span className="text-green-400 font-mono">$22.50/kW</span>
              </div>
              <div className="flex items-center gap-2 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700">
                <TrendingUp className="h-4 w-4 text-red-400" />
                <span className="text-gray-400">Peak TOU Energy:</span>
                <span className="text-red-400 font-mono">$0.42/kWh</span>
              </div>
              <div className="flex items-center gap-2 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700">
                <Battery className="h-4 w-4 text-yellow-400" />
                <span className="text-gray-400">SGIP Commercial:</span>
                <span className="text-yellow-400 font-mono">$200-850/kWh</span>
              </div>
              <div className="flex items-center gap-2 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700">
                <Calculator className="h-4 w-4 text-purple-400" />
                <span className="text-gray-400">Bonus Depreciation:</span>
                <span className="text-purple-400 font-mono">60% (2024)</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <Button
                ...
                className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-6 text-lg shadow-lg shadow-blue-500/30 transform hover:scale-105 transition-all"
              >
              ...
              <Button
                variant="outline"
                className="border-blue-500/50 text-blue-400 hover:bg-blue-500/10 px-8 py-6 text-lg backdrop-blur-sm"
                onClick={() => window.location.href = '#roi-calculator'}
              >
                <Calculator className="mr-2 h-5 w-5" />
                Calculate ROI with Tax Benefits
              </Button>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-4 gap-4 text-sm">
              <div className="bg-black/30 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-blue-300 font-semibold">Manufacturing</h4>
                </div>
                <ul className="space-y-1 text-gray-400">
                  <li>• Peak demand: 200-1000kW</li>
                  <li>• Savings: $10-50K/month</li>
                  <li>• ROI: 2.5-4 years</li>
                </ul>
              </div>
              <div className="bg-black/30 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  <Warehouse className="h-5 w-5 text-green-400" />
                  <h4 className="text-green-300 font-semibold">Cold Storage</h4>
                </div>
                <ul className="space-y-1 text-gray-400">
                  <li>• 24/7 refrigeration loads</li>
                  <li>• Backup power critical</li>
                  <li>• SGIP Equity eligible</li>
                </ul>
              </div>
              <div className="bg-black/30 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  <Heart className="h-5 w-5 text-red-400" />
                  <h4 className="text-red-300 font-semibold">Healthcare</h4>
                </div>
                <ul className="space-y-1 text-gray-400">
                  <li>• Resilience requirements</li>
                  <li>• PSPS zone priority</li>
                  <li>• Critical load backup</li>
                </ul>
              </div>
              <div className="bg-black/30 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  <ShoppingCart className="h-5 w-5 text-purple-400" />
                  <h4 className="text-purple-300 font-semibold">Retail/Office</h4>
                </div>
                <ul className="space-y-1 text-gray-400">
                  <li>• Daytime peak loads</li>
                  <li>• Perfect solar match</li>
                  <li>• 1.5-3 year payback</li>
                </ul>
              </div>
            </div>
          </div>
