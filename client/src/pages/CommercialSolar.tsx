...
const CommercialSolar = () => {
  ...
  return (
    <MainLayout fullWidth={true}>
      ...
      <PageHeroSection
        title="Commercial Three-Phase Solar + Battery Systems"
        subtitle="Sol-Ark 30K/60K • SGIP Incentives • CPUC Rule 21 Fast Track • Demand Charge Optimization"
        ctaButtons={[
          {
      ...
      <section className="py-16 bg-gray-900">
        <FeatureGrid
          ...
          columns={3}
          title="Enterprise-Grade Three-Phase Solar + Storage"
          subtitle="Commercial Technology Stack"
          description="Sol-Ark commercial inverters with integrated battery management, SGIP rebate eligibility, and demand charge optimization algorithms for California commercial rate structures."
          accentColor="blue"
        />
      </section>
