            ...
            <div className="max-w-4xl mx-auto text-center mb-16 relative">
              ...
              <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-950/90 to-black/90 py-10 px-12 rounded-xl border border-gray-800 shadow-[0_10px_25px_rgba(0,0,0,0.3)]">
                ...
                <div className="relative mb-10">
                  <div className="absolute -inset-1 bg-gradient-to-r from-red-600/20 via-red-500/20 to-red-600/20 rounded-xl blur-xl opacity-80"></div>
                  
                  <div className="relative bg-gradient-to-br from-black/70 to-gray-900/70 border border-red-500/30 rounded-xl p-6 backdrop-blur-sm">
