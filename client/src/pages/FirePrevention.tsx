              ...
              <div className="relative z-20 rounded-2xl overflow-hidden p-8 bg-gradient-to-br from-gray-900/95 via-black/98 to-gray-900/95 border border-red-700/30 shadow-[0_10px_50px_-12px_rgba(0,0,0,0.4)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div className="relative group overflow-hidden rounded-xl transform transition-all duration-500 hover:scale-[1.02]">
                    ...
                    <div className="absolute inset-0 bg-red-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl"></div>
                    ...
                    {/* Moving fire particle effect */}
                    <div className="absolute inset-0 opacity-30 overflow-hidden">
                      <div className="absolute -bottom-1 left-0 right-0 h-8 bg-gradient-to-t from-red-600/20 to-transparent animate-flame-slow rounded-b-xl"></div>
                    </div>
              ...
              <div className="relative z-20 rounded-2xl overflow-hidden p-8 bg-gradient-to-br from-gray-900/95 via-black/98 to-gray-900/95 border border-emerald-700/30 shadow-[0_10px_50px_-12px_rgba(0,0,0,0.4)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div className="relative group overflow-hidden rounded-xl transform transition-all duration-500 hover:scale-[1.02]">
                    ...
                    {/* Ambient glow effect on hover */}
                    <div className="absolute inset-0 bg-green-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl"></div>
                    ...
                    <div className="relative z-10 p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-3 rounded-lg bg-black/40">
                          <div className="flex items-center">
                            <CalendarCheck className="h-5 w-5 text-emerald-400 mr-3" />
                            <span className="text-gray-300">Recoating Interval</span>
                          </div>
                          <span className="text-emerald-400 font-medium">15+ years</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl p-6 bg-gradient-to-br from-black/80 to-green-950/30 border border-green-800/30">
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <div className="flex items-start">
                        <div className="h-6 w-6 bg-emerald-900 rounded-full flex items-center justify-center text-white text-sm mr-3 mt-0.5 flex-shrink-0">4</div>
                        <div>
                          <h4 className="text-white font-medium">Compliance Documentation</h4>
                          <p className="text-gray-400 text-sm">Complete documentation package for code compliance and permitting</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
                      <div className="flex flex-col items-center p-3 rounded-lg bg-black/40">
                        <Flame className="h-8 w-8 text-emerald-400 mb-2" />
                        <span className="text-gray-300 text-sm text-center">ASTM E84 Certified</span>
                      </div>
                      
                      <div className="flex flex-col items-center p-3 rounded-lg bg-black/40">
                        <Thermometer className="h-8 w-8 text-emerald-400 mb-2" />
                        <span className="text-gray-300 text-sm text-center">Thermal Barrier Rated</span>
                      </div>
                      
                      <div className="flex flex-col items-center p-3 rounded-lg bg-black/40">
                        <FileText className="h-8 w-8 text-emerald-400 mb-2" />
                        <span className="text-gray-300 text-sm text-center">Code Compliant</span>
                      </div>
                      
                      <div className="flex flex-col items-center p-3 rounded-lg bg-black/40">
                        <Building className="h-8 w-8 text-emerald-400 mb-2" />
                        <span className="text-gray-300 text-sm text-center">WUI Approved</span>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-black/60 to-purple-950/20 rounded-xl border border-purple-700/30 p-6 mb-6">
                        ...
                        <div className="text-center">
                          <div className="relative transform transition-all duration-500 hover:scale-[1.02]">
                            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/30 via-violet-600/30 to-purple-600/30 rounded-lg blur-md opacity-75"></div>
                            <div className="relative">
                              <PremiumCartButton 
                                size="lg"
