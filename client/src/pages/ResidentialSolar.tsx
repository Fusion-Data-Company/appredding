...
const ResidentialSolar = () => {
  ...
  return (
    <MainLayout>
      ...
      {/* Hero Section with Enhanced Technical Specs and Crisis Recognition */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-red-900/20 border border-red-500/50 backdrop-blur-sm rounded-xl p-4 mb-8">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-red-300 font-semibold">NEM 3.0 CRITICAL ALERT: April 15, 2023 Implementation</p>
                <p className="text-gray-400 text-sm mt-1">Export credits reduced 75-80% • Solar-only payback increased to 10-12 years • Battery storage now mandatory for positive ROI</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-semibold text-orange-400 uppercase tracking-wider">C-46 #1084287 • NABCEP PV-102419 • CPUC Rule 21 Certified</span>
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-400 bg-clip-text text-transparent">
              NEM 3.0 Solar + Storage Engineering
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 max-w-5xl mx-auto mb-4">
              Navigate California's Net Billing Tariff with PE-stamped designs, SGIP incentive maximization, and advanced Sol-Ark/LiFePO4 integration
            </p>
            <p className="text-lg text-gray-400 max-w-4xl mx-auto mb-8">
              From orphaned SolarCity systems to complex NEM 3.0 retrofits — 25+ years solving Northern California's toughest solar challenges
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8 text-sm">
              <div className="flex items-center gap-2 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700">
                ...
                <span className="text-gray-400">Live PG&E Export:</span>
                <span className="text-green-400 font-mono">$0.04/kWh</span>
              </div>
              <div className="flex items-center gap-2 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700">
                <TrendingUp className="h-4 w-4 text-red-400" />
                <span className="text-gray-400">Peak TOU Import:</span>
                <span className="text-red-400 font-mono">$0.51/kWh</span>
              </div>
              <div className="flex items-center gap-2 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full border border-gray-700">
                <Battery className="h-4 w-4 text-yellow-400" />
                <span className="text-gray-400">SGIP Funding:</span>
                <span className="text-yellow-400 font-mono">62% Remaining</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <Button
                ...
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-6 text-lg shadow-lg shadow-orange-500/30 transform hover:scale-105 transition-all"
                data-testid="button-consultation"
              >
                <Phone className="mr-2 h-5 w-5" />
                Emergency NEM 3.0 Assessment
              </Button>
              <Button
                variant="outline"
          ...
          <div className="grid lg:grid-cols-4 gap-4 mb-12">
            <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/5 backdrop-blur-sm rounded-2xl p-6 border border-orange-500/30 hover:border-orange-400 transition-all group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-white">Sol-Ark 15K Flagship</h3>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Continuous Power:</span>
                  <span className="text-orange-300 font-mono">15kW</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Peak Surge:</span>
                  <span className="text-orange-300 font-mono">23kW/5s</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">CEC Efficiency:</span>
                  <span className="text-orange-300 font-mono">97.5%</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">MPPT Inputs:</span>
                  <span className="text-orange-300 font-mono">3 × 600V</span>
                </div>
                <div className="flex justify-between text-sm">
            ...
            <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 backdrop-blur-sm rounded-2xl p-6 border border-blue-500/30 hover:border-blue-400 transition-all group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-white">SimpliPhi PHI 3.8</h3>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Usable Capacity:</span>
                  <span className="text-blue-300 font-mono">3.8kWh</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Chemistry:</span>
                  <span className="text-blue-300 font-mono">LiFePO4</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Cycle Life:</span>
                  <span className="text-blue-300 font-mono">10,000</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">DoD Rating:</span>
                  <span className="text-blue-300 font-mono">100%</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Scalability:</span>
                  <span className="text-blue-300 font-mono">14 parallel</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-green-600/5 backdrop-blur-sm rounded-2xl p-6 border border-green-500/30 hover:border-green-400 transition-all group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-white">SGIP Calculator</h3>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Equity Tier:</span>
                  <span className="text-green-300 font-mono">$1,000/kWh</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">General Tier:</span>
                  <span className="text-green-300 font-mono">$250/kWh</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">15kWh System:</span>
                  <span className="text-green-300 font-mono">$3,750-15k</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">ITC 30%:</span>
                  <span className="text-green-300 font-mono">+$6,000</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Total Offset:</span>
                  <span className="text-green-300 font-mono">40-65%</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/30 hover:border-purple-400 transition-all group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-white">Smart Integration</h3>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Monitoring:</span>
                  <span className="text-purple-300 font-mono">24/7 Portal</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">TOU Shifting:</span>
                  <span className="text-purple-300 font-mono">Automated</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Grid Services:</span>
                  <span className="text-purple-300 font-mono">VPP Ready</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">EV Integration:</span>
                  <span className="text-purple-300 font-mono">J1772 API</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Response SLA:</span>
                  <span className="text-purple-300 font-mono">2hr 24/7</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-red-900/20 to-orange-900/20 border border-red-500/30 rounded-2xl p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="bg-black/30 rounded-lg p-4">
                <h4 className="text-red-400 font-semibold mb-2">Without Battery</h4>
                <ul className="space-y-1 text-gray-400">
                  <li>• Export at $0.03-0.05/kWh</li>
                  <li>• Buy back at $0.32-0.51/kWh</li>
                  <li>• 10-12 year payback</li>
                  <li>• Negative monthly cash flow</li>
                </ul>
              </div>
              <div className="bg-black/30 rounded-lg p-4">
                <h4 className="text-yellow-400 font-semibold mb-2">With Battery + SGIP</h4>
                <ul className="space-y-1 text-gray-400">
                  <li>• Avoid peak rates completely</li>
                  <li>• Arbitrage 10x price delta</li>
                  <li>• 5-7 year payback</li>
                  <li>• $150-300 monthly savings</li>
                </ul>
              </div>
              <div className="bg-black/30 rounded-lg p-4">
                <h4 className="text-green-400 font-semibold mb-2">APR Advantage</h4>
                <ul className="space-y-1 text-gray-400">
                  <li>• SGIP application expertise</li>
                  <li>• Orphan system rescue</li>
                  <li>• Load profile optimization</li>
                  <li>• 99.1% PTO success rate</li>
                </ul>
              </div>
            </div>
          </div>
