      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        <Link href="/" className="text-2xl font-heading font-bold flex items-center gap-2 group z-10">
          ...
          <div className="tracking-tight flex items-center gap-0.5">
            <span className="gradient-text-blue mr-0.5 dark:text-shadow-[0_0_8px_rgba(255,255,255,0.5)] text-shadow-[0_0_1px_rgba(0,0,0,1),0_2px_3px_rgba(0,0,0,0.5)]">Praetorian</span>
            <span className="gradient-text-fire dark:text-shadow-[0_0_8px_rgba(255,255,255,0.5)] text-shadow-[0_0_1px_rgba(0,0,0,1),0_2px_3px_rgba(0,0,0,0.5)]">Coatings</span>
          </div>
        </Link>
