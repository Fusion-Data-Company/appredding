...
// ============================================================================
// FLOATING ENERGY PARTICLES (Exact from demo)
// ============================================================================
...
const MaintenanceWaveHero: React.FC<MaintenanceWaveHeroProps> = ({
  tagline = "Professional Solar System Care",
  title = "Expert Maintenance Services",
  subtitle = "Keep your solar investment operating at peak performance with our certified technicians. Professional maintenance ensures maximum efficiency and longevity.",
  stats = [
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      {/* Gradient Overlays (Exact from demo) */}
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          {/* Main Heading (Exact typography from demo) */}
          <motion.h1
          ...
          >
            ...
            <br />
            <span className="text-white">Maintenance & Care</span>
          </motion.h1>

          {/* Subtitle (Exact typography from demo) */}
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
