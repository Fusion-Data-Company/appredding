  ...
  return (
    <footer className="relative border-t dark:border-[#333333] border-gray-300 pt-8 pb-4 mt-auto overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <a
                ...
                aria-label="Facebook"
                className="dark:text-[#a0a0a0] text-gray-600 hover:text-blue-600 transition-colors"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Twitter"
                className="dark:text-[#a0a0a0] text-gray-600 hover:text-blue-400 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="dark:text-[#a0a0a0] text-gray-600 hover:text-blue-700 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              <a
                ...
                className="dark:text-[#a0a0a0] text-gray-600 hover:text-pink-600 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="text-gray-400 font-semibold mb-0 text-xs">Register:</p>
                  <a href="mailto:register@praetoriansmartcoat.com" className="text-[#a0a0a0] hover:text-amber-500 transition-colors break-all text-sm">
        ...
        <div className="pt-3 border-t dark:border-[#333333] border-gray-300 text-center dark:text-[#a0a0a0] text-gray-700 text-xs relative">
          <p className="dark:text-gray-300 text-gray-700">
            &copy; {new Date().getFullYear()} Praetorian SmartCoat Solutions. All rights reserved.
          </p>
          <div className="mt-1 space-x-4">
            <a href="/privacy-policy" className="dark:text-gray-300 text-gray-700 hover:text-amber-500 transition-colors">
              Privacy Policy
            </a>
            <a href="/terms" className="dark:text-gray-300 text-gray-700 hover:text-amber-500 transition-colors">
              Terms of Service
            </a>
            <a href="/contact" className="dark:text-gray-300 text-gray-700 hover:text-amber-500 transition-colors">
              Contact Us
            </a>
          </div>
