      ...
      <div className="container mx-auto px-4 relative z-[100]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:orders@praetoriansmartcoat.com" className="text-white hover:text-amber-500 transition-colors break-all text-sm font-medium">
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:office@praetoriansmartcoat.com" className="text-white hover:text-amber-500 transition-colors break-all text-sm font-medium">
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:distributors@praetoriansmartcoat.com" className="text-white hover:text-amber-500 transition-colors break-all text-sm font-medium">
            ...
            <div className="flex space-x-2 mt-3">
              <a href="https://facebook.com/praetoriansmartcoat" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="dark:text-white text-gray-600 hover:text-blue-600 transition-colors">
              ...
              <a href="https://twitter.com/praetoriancoat" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="dark:text-white text-gray-600 hover:text-blue-400 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                  <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
                </svg>
              </a>
              <a href="https://linkedin.com/company/praetorian-smartcoat" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="dark:text-white text-gray-600 hover:text-blue-700 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                  <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                </svg>
              </a>
              <a href="https://instagram.com/praetoriansmartcoat" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="dark:text-white text-gray-600 hover:text-pink-600 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
        ...
        <div className="pt-2 border-t dark:border-[#333333] border-gray-300 text-center dark:text-white text-gray-700 text-xs relative">
          ...
          <div className="mt-0.5 space-x-3">
            ...
            <a href="/terms" className="dark:text-white text-gray-700 hover:text-amber-500 transition-colors text-[11px] font-medium">
              Terms of Service
            </a>
            <a href="/contact" className="dark:text-white text-gray-700 hover:text-amber-500 transition-colors text-[11px] font-medium">
              Contact Us
            </a>
          </div>
