        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <a href="/products#benefits" className="text-white hover:text-[#0070f3] transition-colors text-xs font-medium">
                  Product Benefits
                </a>
              </li>
              <li>
                <a href="/technology" className="text-white hover:text-[#0070f3] transition-colors text-xs font-medium">
                  Performance Data
                </a>
              </li>
              <li>
                <a href="/technology#specs" className="text-white hover:text-[#0070f3] transition-colors text-xs font-medium">
                  Technical Specifications
                </a>
              </li>
              <li>
                <a href="/documents/sds" className="text-white hover:text-[#0070f3] transition-colors text-xs font-medium">
                  Safety Data Sheet
                </a>
              </li>
            </ul>
