                          ...
                          <div className="md:w-1/3 flex justify-center items-center">
                            ...
                            <div className="relative group/image overflow-hidden">
                              ...
                              <div className={`absolute bottom-0 left-0 right-0 p-4 ${
                                ...
                                <p className="text-white text-sm font-medium opacity-0 group-hover/image:opacity-100 transform translate-y-4 group-hover/image:translate-y-0 transition-all duration-500" style={{marginTop: "50px", position: "relative", top: "30px"}}>
