        ...
        {!isOpen && (
          ...
          >
            <GradientButton 
              ...
              className="rounded-full shadow-[0_0_30px_rgba(255,69,0,0.5)] flex items-center gap-2"
              variant="default"
              size="lg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-5 rounded-lg border border-gray-800 shadow-lg">
            <div className="flex items-center mb-3">
              ...
              <h4 className="text-amber-400 font-bold">Thermal Emittance</h4>
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-5 rounded-lg border border-gray-800 shadow-lg">
            <div className="flex items-center mb-3">
              ...
              <h4 className="text-amber-400 font-bold">Acoustic Dampening</h4>
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-5 rounded-lg border border-gray-800 shadow-lg">
            <div className="flex items-center mb-3">
              ...
              <h4 className="text-amber-400 font-bold">Durability</h4>
            </div>
