    ...
    >
      ...
      <Link href="/" className="absolute left-0 top-0 h-full flex items-center z-20">
        <div className="relative">
          ...
          <div className="absolute inset-0 rounded-full bg-black/30 blur-md -z-10 scale-90 translate-y-1 translate-x-1"></div>
          <img 
      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        {/* Logo (text portion) */}
        <div className="flex items-center gap-5 z-10 group relative" style={{ marginLeft: '-392px' }}>
          <Link href="/" className="flex items-center w-96 ml-0 mt-6">
            ...
            <div className="flex flex-col justify-center relative">
              ...
              <span className="text-[1.05rem] text-slate-700 dark:text-slate-400 font-medium tracking-widest uppercase group-hover:text-black dark:group-hover:text-white transition-colors duration-300 mt-[-5px] whitespace-nowrap relative z-30" style={{ marginLeft: '-36px' }}>
