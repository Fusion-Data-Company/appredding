    ...
    >
      ...
      <Link href="/" className="absolute left-0 top-0 h-full flex items-center z-20">
        <div className="relative">
          ...
          <div className="absolute inset-0 rounded-full bg-black/30 blur-md -z-10 scale-91 translate-y-1 translate-x-1 -translate-y-[10px]"></div>
          <img 
            ...
            style={{ 
              ...
              transform: 'perspective(800px) rotateY(-5deg) scale(1.6) translateY(-10px)',
