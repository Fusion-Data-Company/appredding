        ...
        <div className="flex items-center gap-5 z-10 group relative" style={{ marginLeft: '-392px' }}>
          <Link href="/" className="flex items-center w-96 ml-0 mt-6">
            ...
            <div className="flex flex-col justify-center relative">
              ...
              <span className="text-[1.05rem] text-slate-700 dark:text-slate-400 font-medium tracking-widest uppercase group-hover:text-black dark:group-hover:text-white transition-colors duration-300 mt-[-5px] text-center w-full block" style={{ marginLeft: '-24px' }}>
